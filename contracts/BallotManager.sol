...
contract BallotManager {
    ...
    function createBallot(
        ...
        emit ballotCreated(_ballotId, _name, _endTime, _sismoGroupId, _candidateGroupId, _dkgRitualId, _protocolVersion);
    }
    ...
    function addCandidate(string memory _ballotId, string memory _title, string memory _description, string memory _proof, string memory _invoice) external {
        ...
        emit candidateAdded(_ballotId, _title, _description, _proof, _invoice);
    }
